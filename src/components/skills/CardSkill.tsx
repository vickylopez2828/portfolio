...
export default function CardSkill({tecnologia}) {
  ...
  return (
    <div className='sm:w-[88px] shadow-[0_0px_5px_rgba(10,135,245,0.8)] rounded-xl py-4 px-3 flex flex-col items-center justify-center gap-1 sm:gap-3 hover:scale-110 cursor-pointer'>
