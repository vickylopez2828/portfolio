  ...
  return (
    <div className=' w-full flex flex-col gap-8 sm:w-4/5  bg-[rgb(26,26,26)] mx-6 my-2 pb-4 lg:mx-16 rounded-lg overflow-y-scroll'>
      <div className="flex mx-auto items-center my-8 animate-fade-down"> 
          <h1 className= 'text-center text-2xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white '><span className="text-transparent tracking-widest bg-clip-text bg-gradient-to-r from-[#0a87f5] via-[#ae31fc] to-[#fc31f9]"> 
