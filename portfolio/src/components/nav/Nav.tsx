  ...
  return (
    <div className='bg-[rgb(26,26,26)] sm:flex sm:w-auto lg:w-1/5 flex-col justify-between gap-4 rounded-[10px] pt-4'>
        <div className='flex flex-col items-center '>
          ...
          <p className=' text-xs md:text-sm lg:text-base font-black text-[rgb(146,146,146)]'>Desarrolladora Web</p>
          <div className='rounded-full bg-red w-8 h-8 absolute'></div>
        </div>
